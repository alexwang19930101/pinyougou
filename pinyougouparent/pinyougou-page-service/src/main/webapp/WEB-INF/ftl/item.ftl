                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specificationList as spec>
                            <dl>
                                ...
                                <#list spec.attributeValue as specAttrVal>
                                    <dd><a href="javascript:;"
                                           ng-click="selectSpecification('${spec.attributeName}','${specAttrVal}')"
                                           class="{{isSelected('${spec.attributeName}','${specAttrVal}')?'selected':''}}">
                                        ${specAttrVal}<span title="点击取消选择">&nbsp;</span>
                                    </a>
                                    </dd>
                                </#list>
                            </dl>
